...
| ID | KPI | Status | Value | Source | Notes |
|---|---|---|---|---|---|
| `paper.sections_created` | Sections created | future | 15 | Paper repository | Count section files or paper outline entries. |
| `paper.sections_drafted` | Sections drafted | future | 15 | Paper repository | Count sections with draft content. |
